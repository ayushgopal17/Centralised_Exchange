...
export function CandlestickChart() {
  ...
  const { candles, loading, error, refresh } = useMarketCandles("SOLUSDT", interval);
  ...
  useEffect(() => {
    ...
    candleSeries.current = chart.addSeries(CandlestickSeries, { upColor: "#42e6a4", downColor: "#ff5975", borderVisible: false, wickUpColor: "#42e6a4", wickDownColor: "#ff5975", priceFormat: { type: "price", precision: 2, minMove: 0.01 } });
  ...
  return (
    <section className="panel chart-panel">
      <div className="panel-heading chart-heading">
        <div><h2>SOL / USDT</h2><span className="source-label"><i /> Binance market reference</span></div>
