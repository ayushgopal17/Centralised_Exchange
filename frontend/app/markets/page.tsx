...
export default function MarketsPage() {
  ...
  return <AppShell><div className="content-page">
    <div className="page-title-row"><div><div className="eyebrow">MARKET INTELLIGENCE</div><h1>Markets</h1><p>Live public spot reference data, with CEX trading availability shown separately.</p></div><div className="market-tools"><div className="search-box"><Search size={17} /><input aria-label="Search markets" placeholder="Search markets" value={query} onChange={(event) => setQuery(event.target.value)} /></div><button className="page-refresh" onClick={refresh} aria-label="Refresh markets"><RefreshCw size={16} /></button></div></div>
    <div className="data-provenance"><span><i /> Live public data</span><strong>Binance USDT spot markets</strong><small>Visualization only · account and execution data remain on CEX</small></div>
    ...
    <section className="panel markets-card">
      <div className="market-table market-table-head"><span>Market</span><span>Last price</span><span>24h change</span><span>24h high / low</span><span>24h volume</span><span>CEX status</span><span /></div>
